...
const generateChartData = ({ items, keyToGroup, keyOfValue, aliases, type, backgroudColors }) => {
    ...
    case 'bar':
      return {
        datasets: labels.map((label, index) => ({
          ...
          backgroudsColor: backgroudColors[index],
          borderWidth: 0
        }))
      }
    ...
    case 'doughnut':
      return {
        datasets: [{
          ...
          backgroundColor: backgroudColors || generateColors(labels.length),
          borderWidth: 0
        }],
